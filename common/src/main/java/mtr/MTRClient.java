...
import mtr.block.BlockPIDSSingleArrival1;
...
public class MTRClient implements IPacket {
	...
	public static void init() {
		...
		RegistryClient.registerNetworkReceiver(PACKET_APPEND_RAILS, packet -> ClientData.appendRails(Minecraft.getInstance(), packet));

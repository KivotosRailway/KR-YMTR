	...
	public void render(PoseStack matrices, int mouseX, int mouseY, float delta) {
		try {
			...
			if (!Keys.LIFTS_ONLY) {
				...
				drawString(matrices, font, Text.translatable("options.mtr.enable_stopping_scoring"), SQUARE_SIZE, BUTTON_HEIGHT * (i++) + yStart1, ARGB_WHITE);
				...
				drawString(matrices, font, Text.translatable("options.mtr.rail_render_distance"), SQUARE_SIZE, BUTTON_HEIGHT * (i++) + yStart1, ARGB_WHITE);
			}

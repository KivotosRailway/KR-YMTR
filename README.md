> ## 掠人之美，掩人之善 
> ## Usurping Credit, Concealing Merit
> 自2026年7月23日起，本项目由 MIT 协议转为 **ARR（All Rights Reserved）**。
> 保留所有权利。
> Effective immediately, this project's license has been changed from MIT to **ARR (All Rights Reserved)**.
>
> ---
>
> ### 中文
>
> 近日发现，整合包 **RNA**的DLC包，在分发时，对 YMTR 的 JAR 文件进行了如下篡改：
>
> - 将模组名称 **"Yomi's Minecraft Transit Railway"** 改为 **"Minecraft Transit Railway"**
> - 将模组 LOGO 由 **YMTR 的 LOGO** 替换为 **MTR 官方版的 LOGO**
> - Fabric 与 Forge 版本均遭修改，且整合包中未提及 YMTR 分毫
>
> 此举意在 **掠人之美，掩人之善**——窃取他人成果的表面荣光，刻意抹去真正的贡献来源。整合包用户完全无从知晓自己使用的实为 YMTR。与开源精神背道而驰，亦是对贡献者的侮辱。
>
> 特此公示该整合包的相关链接：
>
> - [RNA 整合包地址](https://modrinth.com/modpack/railway-network-access)
> - [RNA 整合包MTRv3DLC包地址](https://www.curseforge.com/minecraft/modpacks/blockitectures-dlc-pack-for-mtrv3)
> - [该作者 MC百科主页](https://www.mcmod.cn/author/38612.html)
>
> 请各位使用者明辨真伪。
>
> ---
> ### English
>
> It has recently come to light that the modpack **RNA** DLC pack has been distributing YMTR with the following tampering applied to its JAR files:
>
> - The mod name **"Yomi's Minecraft Transit Railway"** was changed to **"Minecraft Transit Railway"**
> - The mod logo was replaced from **YMTR's logo** to **the official MTR logo**
> - Both Fabric and Forge builds were altered, and YMTR was **never mentioned** anywhere in the modpack
>
> This is a textbook case of **"掠人之美，掩人之善"** — usurping the credit of another's work while concealing their merits. Users of the modpack have no way of knowing that they are, in fact, using YMTR. This runs counter to the spirit of open source and is a fundamental insult to contributors.
>
> For the community's awareness, relevant links to the offending content are provided below:
>
> - [RNA Modpack](https://modrinth.com/modpack/railway-network-access)
> - [RNA Modpack MTRv3DLC Pack](https://www.curseforge.com/minecraft/modpacks/blockitectures-dlc-pack-for-mtrv3)
> - [Author's Profile](https://www.mcmod.cn/author/38612.html)
>
> Let users see clearly and judge for themselves.
